...
function generatedModal(data) {
    const galleryOfCards = document.getElementById('gallery');
    galleryOfCards.insertAdjacentHTML('aftereend', `<div class="modal-container" style="display:none">
    <div class="modal">
...
closedButton.addEventListener('click', (e) => modalContainer.style.display = "none");
